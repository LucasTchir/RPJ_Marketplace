    ...
    <div class="content" id="content" style="padding-top: 50px;">
        <div class="container p-5">
            <div class="border-bottom border-2 d-flex justify-content-between">
                <h2 class="text-start fw-bold mb-3 fs-3"><a href="/users/{{auth()->user()->username}}" class="link" style="color: darkgrey;">Profil > </a>Upraviť Profil</h2>
                <div class="text-center">
                    <form method="POST" action="/delete/profile/{{auth()->user()->id}}">
                        @csrf
                        @method("DELETE")
                        <button class="btn bg-danger px-3 py-2 fw-semibold" style="background-color: #d9f2ec;">Odstraniť účet</button>
                    </form>
                </div>
            </div>
            ...
            <form method="POST" action="/profile/{{auth()->user()->id}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <!-- Telefon -->
                        <div class="mb-4">
                            <label for="phone" class="form-label fw-semibold">Tel. číslo</label>
                            <input 
                                type="tel" 
                ...
                <div class="text-center">
                    <a href="/setup/{{$user->id}}" class="btn px-5 py-2 fw-bold mb-3" style="background-color: #e6e6e6;">Rozšírené nastavenia</a>
                </div>

                <div class="text-center">
                    <a href="/change-password" class="btn px-5 py-2 fw-bold mb-3" style="background-color: #e6e6e6;">Zmena hesla</a>
                </div>
